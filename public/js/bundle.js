...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, email, password, passConfirmed) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            if (_context3.t0.response.data.message === 'User validation failed: passConfirmed: Passwords are not the same!') {
              (0, _alerts.showAlert)('error', 'Passwords are not the same');
            } else (0, _alerts.showAlert)('error', _context3.t0.response.data.message);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'User Updated Succesfully');
              window.setTimeout(function () {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Failed to update,Please try again');
...
/* global Stripe */
var stripe = Stripe('pk_test_51HWvaLDxyZSIZ01Z2emIxOWjaUR7GNSxtWcMkyMs5MHicMIJwo1GithAdUjJndlycXkT9ffNONkfgLaho6UyGgqy00HRNd0G5n');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.querySelector('.form__signup--name').value;
    var email = document.querySelector('.form__signup--email').value;
    var password = document.querySelector('.form__signup--password').value;
    var passConfirmed = document.querySelector('.form__signup--passConfirmed').value;
    (0, _auth.signup)(name, email, password, passConfirmed);
  });
}
